...
const quickActions = [
  {
    href: "/faucet",
    title: "Shield Funds",
    description: "Mint encrypted test tokens into your confidential vault.",
    icon: (
  ...
  },
  {
    href: "/send",
    title: "Send Payment",
    description: "Transfer an encrypted amount to another wallet.",
    icon: (
      <svg viewBox="0 0 24 24" aria-hidden="true">
  ...
  },
  {
    ...
    description: "Review selective proof trails before public settlement.",
    icon: (
      <svg viewBox="0 0 24 24" aria-hidden="true">
  ...
  return (
    <main className="mx-auto max-w-[1200px] px-4 py-6 sm:px-6 sm:py-8 lg:px-8 lg:py-10">
      <div className="mb-7 max-w-3xl sm:mb-9">
        <p className="text-xs font-bold uppercase tracking-[0.18em] text-zama-soft sm:text-sm">Dashboard</p>
        <h1 className="mt-3 text-3xl font-black leading-tight text-white sm:text-5xl">
          Your confidential balance.
        </h1>
        <p className="mt-3 max-w-2xl text-sm leading-6 text-zinc-400 sm:text-base">
          Manage shielded funds, private payments, and selective receipts from one encrypted vault.
        </p>
      </div>
